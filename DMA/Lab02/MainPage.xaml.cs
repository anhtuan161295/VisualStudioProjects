...
namespace Lab02
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        {
            NavigationService.Navigate(new Uri("/AnimationTest.xaml", UriKind.RelativeOrAbsolute));
        }
        ...
        {
            NavigationService.Navigate(new Uri("/WebBrowseTest.xaml", UriKind.RelativeOrAbsolute));
        }
